...
def network():  # function named network to pass the acronym variable into
    while True:
        ...
        if acronym in acronym_dict:
            print(acronym_dict[acronym] + ' is the acronym of ' + acronym)
            break
        else:
            print('I do not have an acronym stored for that ')
            print('Re-Enter the acronym ?')
            key = input().upper()
            print("What is the acronym's definition")
            value = input()

            acronym_dict.update({key: value})
